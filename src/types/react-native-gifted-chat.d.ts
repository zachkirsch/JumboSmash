...
declare module 'react-native-gifted-chat' {
  ...
  export interface LeftRightStyle<T extends ViewStyle | LinkStyle> {
    left?: StyleProp<T>
    right?: StyleProp<T>
  }
  ...
  export interface GiftedChatProps {
    ...
    /* Callback when a message bubble is long-pressed default is to show an ActionSheet with "Copy Text" */
