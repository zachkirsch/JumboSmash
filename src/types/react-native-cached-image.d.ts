declare module 'react-native-cached-image' {
  ...
  namespace CachedImage {
    ...
    interface Image extends ReactNative.ImageProperties {
      /**
       ...
       */
      loadingIndicator?: ReactNative.ComponentInterface<any> /* tslint:disable-line:no-any */
      /**
       ...
       */
      defaultSource?: ReactNative.ImageURISource | number
      /**
  ...
  export class CachedImage extends React.Component<CachedImage.Image, {}> {}
  export class ImageCacheProvider extends React.Component<CachedImage.ImageCacheProvider, {}> {}
  export const ImageCacheManager: (defaultOptions?: CachedImage.CacheOptions) => CachedImage.ImageCacheManager
